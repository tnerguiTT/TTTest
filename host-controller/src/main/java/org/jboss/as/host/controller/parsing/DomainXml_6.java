...
/**
 * Parser and marshaller for domain-wide configuration xml documents (e.g. domain.xml) that use the urn:jboss:domain:6.0 schema.
 *
 * @author Brian Stansberry
 * @author Emanuel Muckenhuber
 * @author <a href="mailto:darran.lofthouse@jboss.com">Darran Lofthouse</a>
 */
final class DomainXml_6 extends CommonXml implements ManagementXmlDelegate {
