...
/**
 * Parser and marshaller for domain-wide configuration xml documents (e.g. domain.xml) that use the urn:jboss:domain:7.0 schema.
 *
 * @author Brian Stansberry
 * @author Emanuel Muckenhuber
 * @author <a href="mailto:darran.lofthouse@jboss.com">Darran Lofthouse</a>
 */
final class DomainXml_7 extends CommonXml implements ManagementXmlDelegate {
    ...
    DomainXml_7(final ExtensionXml extensionXml, final ExtensionRegistry extensionRegistry, final Namespace namespace) {
